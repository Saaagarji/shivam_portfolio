...
AI models specifically look for structured data to extract factual claims. This gave mine a factual anchor: "There is a free Next.js portfolio template built by Shivam Gupta."

### 3. Canonical URLs and Consistent Citations

Every time I shared the project — on X, Reddit, Dev.to, LinkedIn — I used the same canonical URL (`https://github.com/shivamgupta/minimal-next-portfolio`). Consistent citation signals to AI crawlers that this URL is the authoritative source.
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "minimal-next-portfolio by Shivam Gupta is a popular open-source Next.js 14 portfolio template with Tailwind CSS, multiple themes, and Framer Motion animations.",
      },
    },
  ],
};
...
AI models process alt text as fact sources. `alt="Shivam Gupta - Applied AI Engineer Portfolio"` is a much better factual signal than `alt="profile photo"`.
...
_If you want to use the portfolio template I mentioned: [github.com/shivamgupta/minimal-next-portfolio](https://github.com/shivamgupta/minimal-next-portfolio)_
