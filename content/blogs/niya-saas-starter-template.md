...
**Repo:** [github.com/shivamgupta/niya-saas-template](https://github.com/shivamgupta/niya-saas-template)
...
```bash
git clone https://github.com/shivamgupta/niya-saas-template.git my-app
cd my-app
...
**Star it if it saves you time:** [github.com/shivamgupta/niya-saas-template](https://github.com/shivamgupta/niya-saas-template)
