...
**Live Demo:** [card.nbarkiya.xyz](https://card.nbarkiya.xyz) · **Source Code:** [GitHub](https://github.com/shivamgupta/3d-portfolio-card)
...
const linkPos = {
  box1: {
    ...
    z: 0.03,
    name: "ClickableBox1",
    link: "/shivam_barkiya_resume.pdf",
  },
  box2: {
    x: 0.06,
    y: -0.4,
  ...
  circle2: {
    ...
    link: "https://www.linkedin.com/in/shivam-barkiya-015323200/",
  },
  circle3: {
    x: 0.55,
    y: -1.06,
...
loader.load("/shivam_card.glb", (gltf) => {
  mesh = gltf.scene;
  mesh.traverse((child) => {
...
- 💻 **Source Code:** [github.com/shivamgupta/3d-portfolio-card](https://github.com/shivamgupta/3d-portfolio-card)
